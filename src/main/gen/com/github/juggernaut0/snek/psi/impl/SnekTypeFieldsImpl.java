...
public class SnekTypeFieldsImpl extends ASTWrapperPsiElement implements SnekTypeFields {

  public SnekTypeFieldsImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @Nullable
  public SnekTypeFieldList getTypeFieldList() {
    return findChildByClass(SnekTypeFieldList.class);
  }
