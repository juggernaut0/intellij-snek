...
public class SnekTypeFieldListImpl extends ASTWrapperPsiElement implements SnekTypeFieldList {

  public SnekTypeFieldListImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public List<SnekTypeField> getTypeFieldList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, SnekTypeField.class);
  }
