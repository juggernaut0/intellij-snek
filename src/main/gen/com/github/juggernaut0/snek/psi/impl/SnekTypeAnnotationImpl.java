...
public class SnekTypeAnnotationImpl extends ASTWrapperPsiElement implements SnekTypeAnnotation {

  public SnekTypeAnnotationImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  public SnekTypeName getTypeName() {
    return findNotNullChildByClass(SnekTypeName.class);
  }
