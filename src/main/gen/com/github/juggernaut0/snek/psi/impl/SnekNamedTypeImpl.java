...
public class SnekNamedTypeImpl extends ASTWrapperPsiElement implements SnekNamedType {

  public SnekNamedTypeImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  public SnekQname getQname() {
    return findNotNullChildByClass(SnekQname.class);
  }
